...
public class SettingsProvider : ISettingsProvider
{
    ...
    public void DebugSettingsToLog()
    {
        ...
        _logger.LogInformation("Demo seeding: {Demo}; scan interval: {Seconds}s; keys: {Keys}; password: {Password}",
            settings.Demo, settings.ScanSeconds, settings.Keys ?? "(default)", settings.PasswordRequired ? "configured" : "not set");
    }
